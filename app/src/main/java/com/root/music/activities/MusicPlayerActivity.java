...
public class MusicPlayerActivity extends Activity {
    ...
    private static void updateUI() {
        try {
            ...
            String artist = MusicPlayerConstants.SONGS_LIST.get(MusicPlayerConstants.SONG_NUMBER).getArtist();
            String album = MusicPlayerConstants.SONGS_LIST.get(MusicPlayerConstants.SONG_NUMBER).getAlbum();
            String composer = MusicPlayerConstants.SONGS_LIST.get(MusicPlayerConstants.SONG_NUMBER).getComposer();
        ...
        try {
            ...
            Bitmap albumArt = MusicListUtilFunctions.getAlbumart(context, albumId);
            if (albumArt != null) {
                linearLayoutPlayer.setBackgroundDrawable(new BitmapDrawable(albumArt));
            } else {
                linearLayoutPlayer.setBackgroundDrawable(new BitmapDrawable(MusicListUtilFunctions.getDefaultAlbumArt(context)));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
